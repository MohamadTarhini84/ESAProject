                ...
                <div class="col-10">
                    <div class="row bb pb-3">
                        <div class="col-7">
                            <p>Supplier,</p>
                            <h2>MedCenter</h2>
                            <p class="address">  Institut Francais, <br> Institut Francais <br>Nabatieh </p>
                    ...
                    <div class="row extra-info pt-3">
                        ...
                        <div class="col-5">
                            <p>Delivery Date: <span>27-11.2022</span></p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="media">
                                    <img class="mr-3 img-fluid" src="images/13.jpg" alt="Product 01">
                                    <div class="media-body">
                                        <p class="mt-0 title">Face mask</p>
