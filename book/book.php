            ...
            <div class="content">
                ...
                <div id="tarhini-search-container">
                    <div id="tarhini-upper">
                        <div id="tarhini-head-1" class="tarhini-heading tarhini-button tarhini-selected" onclick="clickFind()">
                            Find
                            a doctor</div>
                    ...
                    <div id="tarhini-lower" class="bg-primary">
                        <div id="option-1" style="display:flex">
                            <form class="tarhini-form" id="datausers">
                                ...
                                <input type="time" name="start_time" class="tarhini-input" id="starttime" class="form-control" />
                        ...
                        <div id="option-2" style="display:none">
                            <form class="tarhini-form" id="userdata">
                                ...
                                <input type="time" id="timefrom" class="tarhini-input" name="timefrom" class="form-control" />
