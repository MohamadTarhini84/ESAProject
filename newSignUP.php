                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"> 
                    ...
                    <div style="display:flex;">     
                        <div class="input_text" style="margin-right:5px"> 
                            ...
                            <div style="color:red;font-size:14px;"><?php  if(isset($genderErr)){echo $genderErr;}?></div>
                            <i class="fa fa-user"></i>
                        </div> 
                        <div class="input_text"> 
                            <input type="text" name="birthday" placeholder="Birthday" onfocus="(this.type='date')" onblur="if(!this.value) this.type='text'">
                            <span style="color:red;font-size:14px;padding-top:25px;height:50%;"><?php  if(isset($birthdayErr)){ echo $birthdayErr;}?></span>
                            <i class="fa fa-solid fa-cake-candles"></i>
                        </div> 
                    </div>
                    <div class="input_text"> 
                        <input type="password" name="password" class="signup_pass" id="passInput" placeholder="Password"> 
                        <span class="error" style="margin-right:12px;margin-top:30px;height:50%;"><?php  if(isset($passwordErr)){ echo $passwordErr;}?></span>
