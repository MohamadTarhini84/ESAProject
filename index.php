    ...
    <div class="banner-text">
        ...
        <div class="medical">
            ...
            <div class="ned">
               ...
               <div class="makebutton"> <button onclick="makebtt()" class="butt" type="button">Make Appoinment</button></div>
        </div>
        </div>
</div>
    ...
    <div class="scrolling-div">
        ...
        <div class="coverting">
            <div class="scroll-pictures">
                <div class="childes-pic"><img class="childes-imges" src="./images/images (1).png" alt="image"> </div>
                <div class="childes-pic"><img class="childes-imges" src="./images/images (3).png" alt="image"> </div>
        ...
        <div>
            <button class="icones-dreis" onclick="scrollets()"><i
    ...
    <div class="blog-cont">
        <div class="blog-section">
            <div class="title-blog">
                ...
                <div class="more-blog"><button onclick="morearticl()" class="button-blog">More Article</button></div>
            </div>
            <div class="contants">
                <div class="blog-card">
