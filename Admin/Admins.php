    ...
    <div class="grid-container" id="blur">
          ...
          ?>
            ...
            <div class="adm-cards">
                ...
                <div class="adm-card">
                    ...
                    <button class="text-primary adm-btn" id="register"> <a href="add-admin.php" style="color:white">
                            Register</a></button>
                </div>
                ...
                <div class="adm-card">
                    ...
                    <button class="text-primary adm-btn" id="viewprof"><a href="update-admin.php"
                            style="color:white">Update Profile</a></button>
                </div>
                <?php
        ...
        ?>
                <div class="adm-card">
                    ...
                    <button class="text-primary adm-btn remove"> <a style="color:white"
                            href="delete-admin.php?a_id=<?php echo $aid ?>">Remove Admin</a> </button>
                </div>
                <?php
        }
