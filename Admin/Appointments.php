            ...
            <div class="main-title">
                <h2 class="font-weight-bold">Appointments
                    <p style="color:#367952;">MedCenter
                        <span style="content: \2192;color: #666666;">&#8594;</span> <small
                            style="color: #666666;">Appointments</small>
                    </p>
                    <?php
            ...
            <div class="charts-card">
              ...
              ?>
                    ...
                    ?>
                      ...
                      ?></td>
                                <td><button><a
                                            href="<?php echo SITEURL; ?>admin/AppDetails.php?app_id=<?php echo $cid ?>&patname=<?php echo $patname ?>&drname=<?php //echo $drName
                                                                                                                                                  ?>">
                                            View</button></td>
                            </tr>
